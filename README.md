...
[![Build status](https://ci.appveyor.com/api/projects/status/y1659o3610trj4be?svg=true)](https://ci.appveyor.com/project/bugagi67/list-crud)
...
Легенда
Вы делаете CRM-систему, где в списке представлены товары.
